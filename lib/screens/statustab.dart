...
import 'package:whysapp/widgets/singlestatus.dart';
                ...
                Stack(
                  children: [
                    CircleAvatar(
                      ...
                      child: CircleAvatar(
                        radius: 28,
                        backgroundImage: AssetImage('assets/rendom.jpg'),
                      ),
                    ),
                  ],
                ),
              ...
              child: const ExpansionTile(
                ...
                children: [
                  SingleStatusItem(
                    ...
                    statusImage: 'assets/mountens.jpg',
                  ),
                  SingleStatusItem(
                    statusTitle: 'Lyanna Mormont',
                    statusTime: '24 minutes ago',
                    statusImage: 'assets/human.jpg',
                  ),
                  SingleStatusItem(
                    statusTitle: 'Daenerys Targaryen',
                    statusTime: '45 minutes ago',
                    statusImage: 'assets/newyork.jpg',
                  ),
                ],
              ),
            )
